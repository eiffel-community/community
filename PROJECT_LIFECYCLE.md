...
request. When accepted, Eiffel Community organization owners create the GitHub project in accordance with the [repository checklist](https://github.com/eiffel-community/eiffel-repository-template/blob/master/repo-checklist.md) and merge the corresponding pull request.

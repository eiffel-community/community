...
- Delete the team under https://github.com/orgs/eiffel-community/teamsL Leaving the team can cause confusion on if the repository has maintainers or not. Removing the team makes this clear.

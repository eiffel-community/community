...
| [Eiffel Translator CDEvents](https://github.com/eiffel-community/eiffel-translator-cdevents) | A translator for events between the Eiffel event protocol and the [CDEvents protocol](https://cdevents.dev/docs/) can interact. | [eiffel-cdevents-maintainers](https://github.com/orgs/eiffel-community/teams/eiffel-cdevents-maintainers) | *Not Available* | [Sandbox](./PROJECT_LIFECYCLE.md#stage-sandbox) |

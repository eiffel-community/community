...
| [Eiffel Demo CDEvents](https://github.com/eiffel-community/eiffel-demo-cdevents) | A demo ground for showing how Eiffel and [CDEvents](cdevents.dev) can interact. | [eiffel-cdevents-maintainers](@eiffel-community/eiffel-cdevents-maintainers) | *Not Available* | [Sandbox](./PROJECT_LIFECYCLE.md#stage-sandbox) |
| [Eiffel Translator CDEvents](https://github.com/eiffel-community/eiffel-translator-cdevents) | A translator for events between the Eiffel event protocol and the [CDEvents protocol](https://cdevents.dev/docs/) can interact. | [eiffel-cdevents-maintainers](@eiffel-community/eiffel-cdevents-maintainers) | *Not Available* | [Sandbox](./PROJECT_LIFECYCLE.md#stage-sandbox) |

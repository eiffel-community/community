...
| [.github](https://github.com/eiffel-community/.github) | GitHub community health files. | [eiffel-community-maintainers](https://github.com/orgs/eiffel-community/teams/eiffel-community-maintainers) | [eiffel-community-maintainers@googlegroups.com](mailto:eiffel-community-maintainers@googlegroups.com) | *Not Applicable* |
...
| [Eiffel GraphQL API](https://github.com/eiffel-community/eiffel-graphql-api) | A GraphQL API-layer set between the eiffel message bus and a MongoDB. | [eiffel-graphql-api-maintainers](https://github.com/orgs/eiffel-community/teams/eiffel-graphql-api-maintainers/members) | [eiffel-graphql-api-maintainers@googlegroups.com](mailto:eiffel-graphql-api-maintainers@googlegroups.com) | [Sandbox](./PROJECT_LIFECYCLE.md#stage-sandbox) |
...
| [Eiffel Sepia](https://github.com/eiffel-community/eiffel-sepia) | Sepia Eiffel Protocol Implementation Architecture - guidance of the Eiffel protocol and its implementations. | [eiffel-sepia-maintainers](https://github.com/orgs/eiffel-community/teams/eiffel-sepia-maintainers/members) | [eiffel-sepia-maintainers@googlegroups.com](mailto:eiffel-sepia-maintainers@googlegroups.com) | [Graduated](./PROJECT_LIFECYCLE.md#stage-graduated) |
| [Eiffel Store](https://github.com/eiffel-community/eiffel-store) | A persistence solution for Eiffel events which accepts live view of Eiffel events. | *Not Available* | *Not Available* | [Archived](./PROJECT_LIFECYCLE.md#stage-archived) |
| [Eiffel Vici](https://github.com/eiffel-community/eiffel-vici) | Eiffel Vici dynamically visualizes Eiffel events retrieved from an Eiffel Event Persistence Service. | *Not Available* | *Not Available* | [Archived](./PROJECT_LIFECYCLE.md#stage-archived) |
| [Eiffelactory](https://github.com/eiffel-community/eiffelactory) | Sends ArtP based on ArtC and what it can find in Artifactory. | [eiffelactory-maintainers](https://github.com/orgs/eiffel-community/teams/eiffelactory-maintainers) | *Not Available* | [Sandbox](./PROJECT_LIFECYCLE.md#stage-sandbox) |
| [ml-jmespath-generator](https://github.com/eiffel-community/ml-jmespath-generator) | Use machine learning to generate JMESPath expression based on input JSON and expected output JSON. | *Not Available* | *Not Available* | [Archived](./PROJECT_LIFECYCLE.md#stage-archived) |
| [SimpleEventSender](https://github.com/eiffel-community/simple-event-sender) | Service providing a REST API for sending Eiffel events. | *Not Available* | *Not Available* | [Archived](./PROJECT_LIFECYCLE.md#stage-archived) |
| [Eiffel Demo CDEvents](https://github.com/eiffel-community/eiffel-demo-cdevents) | A demo ground for showing how Eiffel and [CDEvents](https://cdevents.dev) can interact. | [eiffel-cdevents-maintainers](https://github.com/orgs/eiffel-community/teams/eiffel-cdevents-maintainers) | *Not Available* | [Sandbox](./PROJECT_LIFECYCLE.md#stage-sandbox) |
| [Eiffel Translator CDEvents](https://github.com/eiffel-community/eiffel-translator-cdevents) | A translator for events between the Eiffel event protocol and the [CDEvents protocol](https://cdevents.dev/docs/). | [eiffel-cdevents-maintainers](https://github.com/orgs/eiffel-community/teams/eiffel-cdevents-maintainers) | *Not Available* | [Sandbox](./PROJECT_LIFECYCLE.md#stage-sandbox) |

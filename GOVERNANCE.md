...
The Eiffel community proactively adopts and follows best practices employed by successful open source communities while maintaining a governance agreeable to it's members.

# Governance

Eiffel is a community of projects working on building CI/CD Pipelines using Eiffel Protocol.
...
* coordination of the technical direction of the prroject(s)
...
Members of the Technical Committee are core stakeholders and/or contributors.
